...
| Test | Status | Notes |
|------|--------|-------|
| Goal creation with tasks | ✅ PASS | `strand_create_goal` works, 5 tasks displayed |
...
journalctl --user -u helix --since "5 minutes ago" | grep -i "goals\|broadcast"
```
