 ...
 * Helix Configuration
 *
 * Configure Helix by setting window.CLAWCONDOS_CONFIG before loading the dashboard,
...
function buildDefaults() {
  ...
  // at /clawcondos-ws handles routing to the gateway AND injects goals.changed events.
...
if (typeof window !== 'undefined') {
  window.ClawCondosConfig = _exports;
}
