...
export function createGoalsStore(dataDir) {
  ...
  function load() {
    if (!existsSync(filePath)) {
      return { version: 2, goals: [], strands: [], sessionIndex: {}, sessionStrandIndex: {}, notifications: [], config: {} };
    }
    try {
      ...
      return {
        ...
        goals,
        strands: Array.isArray(parsed.strands) ? parsed.strands : [],
        sessionIndex: parsed.sessionIndex && typeof parsed.sessionIndex === 'object' ? parsed.sessionIndex : {},
        sessionStrandIndex: parsed.sessionStrandIndex && typeof parsed.sessionStrandIndex === 'object' ? parsed.sessionStrandIndex : {},
        notifications: Array.isArray(parsed.notifications) ? parsed.notifications : [],
        config: parsed.config && typeof parsed.config === 'object' ? parsed.config : {},
      };
    } catch (err) {
      return { version: 2, goals: [], strands: [], sessionIndex: {}, sessionStrandIndex: {}, notifications: [], config: {}, _loadError: true };
    }
  }
