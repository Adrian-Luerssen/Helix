/**
 * Project Snapshot
 * Reads strand workspace to build a project overview for PM planning.
 */
...
/**
 * Build a project snapshot from a strand workspace.
 * @param {string} workspacePath - Path to the strand workspace
